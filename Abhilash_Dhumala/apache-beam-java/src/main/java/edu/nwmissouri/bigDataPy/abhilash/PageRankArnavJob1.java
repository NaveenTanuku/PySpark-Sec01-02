 ...
 * file service.
 */
public class PageRankabhilashJob1 {
  ...
  public static void main(String[] args) {
   ...
   // PCollection<String> pcolInput =
    ...
    PCollection<KV<String, String>> pcollectionkvpairs1 = abhilashMapper(p,"go.md",dataFolder);
    PCollection<KV<String, String>> pcollectionkvpairs2 = abhilashMapper(p,"java.md",dataFolder);
    PCollection<KV<String, String>> pcollectionkvpairs3 = abhilashMapper(p,"python.md",dataFolder);
    PCollection<KV<String, String>> pcollectionkvpairs4 = abhilashMapper(p,"README.md",dataFolder);
    
    PCollection<KV<String, String>> pcollectionkvpairs5 = abhilashMapper(p,"compass.md",dataFolder);
    ...
    //                     wordCount.getKey() + ": " + wordCount.getValue()))
        ...
        //pcolLinks.apply(TextIO.write().to("abhilashPR"));
        ...
        PCollectionLinksString.apply(TextIO.write().to("abhilashKV"));
        p.run().waitUntilFinish();
     }


     private static PCollection<KV<String, String>> abhilashMapper(Pipeline p, String dataFile, String dataFolder) {
      String dataPath = dataFolder + "/" + dataFile;
